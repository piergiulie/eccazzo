...
F_val = 40*9.81; % Forza verticale verso il basso applicata al polso [N]
...
function animazione_pushdown_separata(t1, P1_1, P2_1, P3_1, theta1_1, theta2_1, J1, tau1, ...
    ...
    set(ax1, 'Position', [pos1(1)-0.05, pos1(2)-0.09, pos1(3)*1.5, pos1(4)*1.15]);
    set(ax2, 'Position', [pos2(1)-0.05, pos2(2)-0.09, pos2(3)*1.5, pos2(4)*1.15]);
